...
# 2) Page config & home
st.set_page_config(page_title="C.O.D.E. Bank App", layout="wide")
render_home()
...
st.markdown(
    """
    <a href="tel:+2348163715335" style="
        position: fixed; bottom: 20px; right: 20px;
        background-color: #004B8D; color: white;
        padding: 12px 24px; border-radius: 30px;
        text-decoration: none; font-weight: bold;
    ">📞 +2348163715335</a>
    <a href="mailto:onochiedavidson@gmail.com?subject=Help%20with%20C.O.D.M%20Bank%20App" style="
